...
def opcao1():
    ...
    if escolha == 'A':
        if aleatorio == 1:
            print(
                f'{humano.nome} chega atrasada no seu trabalho e é advertida pelo seu superior.')
            ...
            humano.update_scores(fam, rel_casal, bem_est,
                                 trab, estd, segur, saude)
        ...
        if aleatorio == 1:
            print(
                f'Amando cuida do filho e faz a merenda do casal. {humano.nome} chega atempo no trabalho. ')
            ...
            print(
                f'Amando volta a dormir e não faz o que {humano.nome} pediu. ')
...
def opcao2():
    ...
    if escolha == 'A':
        if aleatorio == 1:
            print(
                f'{humano.nome} foi muito imprudente, colocou sua vida em risco é da sua família .')
            ...
            print(
                f'Os dois sujeitos estavam hospedados na casa de frente, não ofereceram perigo, os dois homens esqueceram a chave dentro de casa e o celular. {humano.nome} ligou para um chaveiro 24h para ajudar os dois rapazes e em seguida foi para o trabalho. ')
...
def opcao3():
    ...
    if escolha == 'A':
        if aleatorio == 1:
            print(f'a.	No caminho mais rápido uma pessoa entra na frente do carro, mas ela não foi atropelada, não teve danos materiais, só o susto.')
            ...
            print(
                f'No caminho mais rápido uma pessoa entra na frente do carro. Ao jogar o carro para a calçada {humano.nome} bateu no meio fio e furou o pneu se atrasou. ')
        ...
        if aleatorio == 1:
            ...
            print(
                f'{humano.nome} pega um engarrafamento devido um acidente e chega atrasada no trabalho.')
...
def opcao4():
    ...
    if escolha == 'A':
        ...
        if aleatorio == 1:
            ...
            print(
                f'{humano.nome} perdeu a oportunidade de ter um aumento. Ficou mais tempo com o seu filho.  ')
...
def opcao5():
    ...
    if escolha == 'A':
        if aleatorio == 1:
            print(
                f'{humano.nome} brincou bastante de adivinhação com João no trajeto da escola para o seu trabalho. ')
            ...
            print(
                f'{humano.nome} falou mal do pai na frente do João quando voltava da escola para o seu trabalho. ')
...
def opcao6():
    ...
    if escolha == 'A':
        if aleatorio == 1:
            print(
                f'O desvio que {humano.nome} fez apesar de ser mais longo não houve engarrafamento durante o trajeto, {humano.nome} chegou na faculdade no horário correto.')
            ...
            print(
                f'Durante o desvio houve engarrafamento e {humano.nome} chegou atrasada na faculdade.')
...
def opcao7():
    ...
    if escolha == 'A':
        if aleatorio == 1:
            print(f'Encontra uma vaga e consegue chegar atempo na faculdade ')
        ...
        if aleatorio == 1:
            print(
                f'O motorista que furou a frente da {humano.nome} pede desculpas e tira o carro da vaga. {humano.nome} chega no horário na sala de aula.')
...
def opcao8():
    ...
    if escolha == 'A':
        if aleatorio == 1:
            print(
                f'Mesmo estando exausta de uma longa jornada de trabalho, {humano.nome} cuida do filho, prepara a sua janta, toma banho e vai dormir.')
        ...
        if aleatorio == 1:
            print(
                f'Apesar do problema de alcoolismo do Marido, {humano.nome} acredita que Amando vai superar essa fase. Ela priorizou o cuidado de todos os integrantes da família.')
